                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <?php
                                if (is_user_logged_in()) {
                                    $data_attr = 'href="'.$redirect.'" ';
                                }else {
                                    $data_attr = 'href="javascript:;" data-toggle="modal" data-target=".tg-user-modal"';
                                }
                            ?>
                            <h4><?php pll_e('Verified Patient Review Process');?></h4>
                            <p><?php pll_e('i) To write a review in this section you must have a patient review code provided by the specialist.');?></p>
                            <p><?php pll_e('ii) If you have completed booking a specialist online, please write your reviews from your <a '.$data_attr.' class="btn btn-primary">Patient Dashboard</a>');?></p>
                          </div>
                        </div>
                        <?php }?>
                        <div class="clearfix"></div>
                        ...
                        <?php if( !is_user_logged_in() ){?>
                            <div class="col-sm-6">
                              <div class="form-group">
                                <input type="text" name="guest_name" class="form-control" placeholder="<?php pll_e('Name');?>">
                              </div>
                            </div>
                            <div class="col-sm-6">
                              <div class="form-group">
                                <input type="text" name="guest_email" class="form-control" placeholder="<?php pll_e('Email');?>">
                              </div>
                            </div>
                        <?php }?>
                        <?php                        
                        ...
                        <div class="col-sm-6">
                          <div class="form-group">
                            <input type="text" name="review_code" class="form-control" placeholder="<?php pll_e('Review Code');?>">
                          </div>
                        </div>
                        <?php }?>
                        <div class="col-sm-6">
                        ...
                        <?php }?>
                          <input type="hidden" name="user_rating[recommendation]" class="user_rating" value="5" />
