				...
				<div class="tg-docinfo tg-haslayout">
					<div class="tg-box">
						<div class="tg-heading-border tg-small">
							<h3><?php pll_e('welcome, ');?><?php echo get_the_author_meta('display_name',$user_identity );?></h3>
						</div>
						...
						<div class="tg-bottominfo tg-haslayout">
							<div class="tg-regardsleft"> <em><?php pll_e('Regards,');?></em> <strong><?php echo esc_attr(get_bloginfo('description')); ?></strong> </div>
