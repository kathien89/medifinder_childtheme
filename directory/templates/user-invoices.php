...
<div id="tg-dashboard-invoice" class="tg-dashboard-invoice tg-haslayout">
  <table class="col-md-12 table-striped ">
    <thead class="cf">
      <tr>
        <th><?php pll_e('Invoice ID');?></th>
        <th class="numeric"><?php pll_e('Amount');?></th>
      </tr>
    </thead>
    <tbody>
      <?php 
      ...
      <tr>
        ...
        <td data-title="Change %" class="numeric">
            ...
            <a data-placement="top" data-toggle="popover" data-trigger="focus" data-container="body" data-placement="top" type="button" data-html="true" href="javascript:;" id="login"><i class="fa fa-info-circle" aria-hidden="true"></i><span>view</span></a></li>
            <div id="popover-content" class="hide">
            	<div class="invoice-complete-info">
                    <div class="item-data">
                        <span class="invoice-head"><?php pll_e('Invoice ID');?>:&nbsp;</span>
                        <span class="invoice-desc"><?php echo esc_attr( $transaction_id );?></span>
                    </div>
                    <div class="item-data">
                        <span class="invoice-head"><?php pll_e('Package Name');?>:&nbsp;</span>
                        <span class="invoice-desc"><?php echo esc_attr( ucwords($package) );?></span>
                    </div>
                    <div class="item-data">
                        <span class="invoice-head"><?php pll_e('Amount');?>:&nbsp;</span>
                        <span class="invoice-desc"><?php echo esc_attr( $mc_currency.$price );?></span>
                    </div>
                    <div class="item-data">
                        <span class="invoice-head"><?php pll_e('Payment Method');?>:&nbsp;</span>
                        <span class="invoice-desc"><?php echo esc_attr( ucwords($payment_method) );?></span>
                    </div>
                    <div class="item-data">
                        <span class="invoice-head"><?php pll_e('Payment Status');?>:&nbsp;</span>
                        <span class="invoice-desc"><?php echo esc_attr( ucwords($order_status) );?></span>
                    </div>
                    <div class="item-data">
                        <span class="invoice-head"><?php pll_e('Payment Date');?>:&nbsp;</span>
      ...
      <tr>
      	<td colspan="5">
			<?php DoctorDirectory_NotificationsHelper::informations(esc_html__('No payement made yet.'));?>
        </td>
      </tr>
     <?php endif;?>
    </tbody>
