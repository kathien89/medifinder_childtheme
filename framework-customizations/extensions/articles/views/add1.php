...
if( apply_filters('docdirect_get_packages_setting','default') === 'custom' ){
	...
	$remaining_articles = intval( $remaining_articles ) + 1; //total in package and one free
} else{
	$remaining_articles = 1000; //total in package and one free
}
			                ...
			                <div class="tab-content">
			                    <div id="English1" class="tab-pane fade in active">
									<div class="form-group">
			                        	<input type="text" value="" name="article_title" class="form-control" placeholder="<?php esc_html_e('Article Title', 'docdirect'); ?>">
			                    	</div>
									<div class="form-group">
			                    ...
			                    <div id="Traditional1" class="tab-pane fade in">
									<div class="form-group">
			                        	<input type="text" value="" name="title_hk" class="form-control" placeholder="<?php esc_html_e('Article Title', 'docdirect'); ?>">
			                    	</div>
									<div class="form-group">
			                    ...
			                    <div id="Simplified1" class="tab-pane fade in">
									<div class="form-group">
			                        	<input type="text" value="" name="title_cn" class="form-control" placeholder="<?php esc_html_e('Article Title', 'docdirect'); ?>">
			                    	</div>
									<div class="form-group">
			                        	<?php wp_editor($content, 'article_detail_hk', $settings); ?> 
			                    	</div>
			                    ...
			                    <div id="French1" class="tab-pane fade in">
									<div class="form-group">
			                        	<input type="text" value="" name="title_fr" class="form-control" placeholder="<?php esc_html_e('Article Title', 'docdirect'); ?>">
			                    	</div>
									<div class="form-group">
			                        	<?php wp_editor($content, 'article_detail_hk', $settings); ?> 
			                    	</div>
