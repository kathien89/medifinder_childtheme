			...
			if( isset( $status ) && $status === 'publish' ){
				...
				while ($query->have_posts()) : $query->the_post();
					...
					<div class="tg-dashboardtitle">
						<h2><?php pll_e('Edit Article', 'docdirect'); ?></h2>
					</div>
                                        ...
                                        <div class="tab-content">
                                            <div id="English" class="tab-pane fade in active">
                                                <div class="form-group">
                                                    <input type="text" value="<?php the_title(); ?>" name="article_title" class="form-control" placeholder="<?php pll_e('Article Title', 'docdirect'); ?>">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div id="Traditional" class="tab-pane fade in">
                                                <div class="form-group">
                                                    <input type="text" value="<?php echo $title_hk; ?>" name="title_hk" class="form-control" placeholder="<?php pll_e('Article Title', 'docdirect'); ?>">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div id="Simplified" class="tab-pane fade in">
                                                <div class="form-group">
                                                    <input type="text" value="<?php echo $title_cn; ?>" name="title_cn" class="form-control" placeholder="<?php pll_e('Article Title', 'docdirect'); ?>">
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <div id="French" class="tab-pane fade in">
                                                <div class="form-group">
                                                    <input type="text" value="<?php echo $title_fr; ?>" name="title_fr" class="form-control" placeholder="<?php pll_e('Article Title', 'docdirect'); ?>">
                                                </div>
                                                <div class="form-group">
                        ...
                        <input class="pdf_file" type="hidden" name="attachment_file" value="<?php echo $attachment_files1;?>">
								...
								<fieldset>
									<div id="tg-updateall" class="tg-updateall">
										<div class="tg-holder">
											<span class="tg-note"><?php pll_e('Click to', 'docdirect'); ?> <strong> <?php pll_e('Update Article Button', 'docdirect'); ?> </strong> <?php pll_e('to update the article.', 'docdirect'); ?></span>
											<?php wp_nonce_field('docdirect_article_nounce', 'docdirect_article_nounce'); ?>
											<a class="tg-btn process-article" data-type="update" href="javascript:;"><?php pll_e('Update Article', 'docdirect'); ?></a>
										</div>
									</div>
								</fieldset>
							</form>
