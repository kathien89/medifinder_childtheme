				...
				foreach ( $user_query->results as $user ) {
                  ...
                  <div class="doc-featurelist item">
                    <figure class="doc-featureimg"> 
                        ...
                        <a href="<?php echo get_author_posts_url($user->ID); ?>" class="list-avatar"><img src="<?php echo esc_attr( $avatar );?>" alt="<?php echo esc_attr( $directories_array['name'] );?>">
                      <figcaption></figcaption></a>
                    </figure>
                    <div class="doc-featurecontent">
                      <div class="doc-featurehead">
                        <?php docdirect_get_wishlist_button($user->ID,true,'v2');?>
                        <h2><a href="<?php echo get_author_posts_url($user->ID); ?>" class="list-avatar"><?php echo ( kt_get_title_name($user->ID).$get_username );?></a></h2>
                      ...
                      <ul class="doc-addressinfo">
                        <li> <i class="fa fa-usd"></i>
                            <span class="fee">$<?php echo get_user_meta($user->ID,'price_min',true); ?> - $<?php echo get_user_meta($user->ID,'price_max',true); ?></span>
                        </li>
                        <?php if( !empty( $user->address ) ) {?>
                        <li> <i class="fa fa-map-marker"></i>
                          <address><?php echo esc_attr( $user->address );?></address>
                        </li>
                        <?php }?>
