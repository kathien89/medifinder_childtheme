...
class DPayPal {
    ...
    //API Credentials
    protected $username = "hunter.asian-facilitator_api1.gmail.com"; //PayPal API username
    protected $password = "FCL2AE59FTRYB3KW"; //PayPal API password
    protected $apiSignature = "A5MJnBbYdMIxBtRnzGT2Oz3Q6PRfA-Frn5oEmhuj8P1Slc.sdg.W21TQ"; //PayPal API signature
    protected $apiVersion = "108.0"; //Set PayPal API version
