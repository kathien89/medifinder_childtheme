...
function kt_get_tag_company($user_id,$icon='') {
	...
	if ($icon == false) { echo '<div class="wrap_tag">';}
	if( in_array('company', $list_terms) ||
		...
		if ($icon == true) {
			echo '<li class="tg-varified"><a class="company_tag" href="javascript:;">'.$icon_flag. $tit . '</a></li>';
		}else {
			echo '<a class="company_tag" href="javascript:;">'.$icon_flag. $tit . '</a>';
		}
	}else {
		if ($icon == true) {
			echo '<li class="tg-varified"><a class="company_tag" href="javascript:;">'.$icon_flag. pll__('Professional'). '</a></li>';
		}else {
			echo '<a class="company_tag" href="javascript:;">'.$icon_flag. pll__('Professional'). '</a>';
		}
	}
	if ($icon == false) { echo '</div>';}
}
