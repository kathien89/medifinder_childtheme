...
if (!class_exists('KT_TG_FEATURED_USERS')) {

    class KT_TG_FEATURED_USERS extends WP_Widget {
...
add_action('widgets_init', create_function('', 'return register_widget("KT_TG_FEATURED_USERS");'));
