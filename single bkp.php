...
<div class="container">
	<div class="row">
		<div id="tg-towcolumns" class="tg-haslayout">
						...
						></iframe></figure>';
							...
							<div class="tg-about-author tg-haslayout">
								...
								<div class="tg-author-content">
									<h3><?php esc_html_e('About','docdirect');?>&nbsp;<?php echo esc_attr( $author->first_name.' '.$author->last_name );?></h3>
                                    <div class="tg-description">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 sidebar-section <?php echo sanitize_html_class($aside_class); ?>">
